...
public class PayActivity extends BaseActivity {
    ...
    ActivityPayBinding layoutBinding;
    ...
    private void initializeUi() {
        ...
        layoutBinding = ActivityPayBinding.inflate(getLayoutInflater());
...
//                });
    ...
    private void setGooglePayAvailable(boolean available) {
        if (available) {
            ...
            Toast.makeText(this, "googlepay_status_unavailable", Toast.LENGTH_LONG).show();
